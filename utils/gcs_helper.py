...
# A valid static-image Short can be smaller than 100 KB after H.264
# compression; size alone must not reject it.  Keep only a small corruption guard.
MIN_VIDEO_SIZE = 1_000  # 1 KB minimum
